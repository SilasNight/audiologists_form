...
class Ui:
    def __init__(self):
        ...
        self.fourKHz_top.place(x=640, y=870)
        self.fourKHz_mid.place(x=640, y=870)
        self.fourKHz_bot.place(x=640, y=870)
        self.twoKHz_top.place(x=512, y=885)
        self.twoKHz_mid.place(x=512, y=885)
        self.twoKHz_bot.place(x=512, y=900)
